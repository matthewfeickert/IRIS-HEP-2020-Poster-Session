...
\begin{multicols}{2} % This is how many columns your poster will be broken into, a portrait poster is generally split into 2 columns
 ...
 %  \begin{flushright}
 %   \href{https://github.com/scikit-hep/pyhf}{\includegraphics[width=0.3\linewidth]{GitHub_logo.png}}
 %  \end{flushright}
 % \end{minipage}%
 % \quad
 % \begin{minipage}{0.5\linewidth}
 %  \begin{flushleft}
 %   \href{https://github.com/scikit-hep/pyhf}{\includegraphics[width=0.3\linewidth]{github_qr_code.pdf}}
 %  \end{flushleft}
 % \end{minipage}%
 ...
 \noindent\fcolorbox{NSF-violet}{NSF-violet}{%
  \begin{minipage}[t]{\pagewidth}
   \begin{minipage}{0.1\linewidth}
    \begin{center}
     \href{https://www.nsf.gov/}{\includegraphics[width=0.99\linewidth]{NSF_logo.png}}
    \end{center}
   \end{minipage}%
